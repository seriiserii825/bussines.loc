...
Container::make( 'post_meta', __( 'Page Options', 'crb' ) )
	...
	->where( 'post_id', '=', '72' ) // only show our new fields on pages
	/**
	 * Advantages
	 */
	->add_tab(__('Block Advantages'), array(
		Field::make('text', 'crb_block_advantages_title', 'Block Advantages title'),
		Field::make('textarea', 'crb_block_advantages_text', 'Block Advantages text'),
	))
	/**
	 * Offer
	 */
	->add_tab(__('Block Offer'), array(
		Field::make('text', 'crb_block_offer_title', 'Block Offer title'),
		Field::make( 'media_gallery', 'crb_media_offer_gallery', __( 'Media Gallery' ) )
			->set_type( array( 'image' ) ),
		Field::make('textarea', 'crb_block_offer_text', 'Block Offer text'),
	))
	/**
	 * Stuff
	 */
	->add_tab(__('Block Stuff'), array(
		Field::make('text', 'crb_block_stuff_title', 'Block Stuff title'),
		Field::make( 'media_gallery', 'crb_media_gallery', __( 'Media Gallery' ) )
			->set_type( array( 'image' ) ),
		Field::make('textarea', 'crb_block_stuff_text', 'Block Stuff text'),
	));
//	//advanced
